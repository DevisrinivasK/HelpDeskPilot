const mongoose = require('mongoose');
     ...
     async function seedDatabase() {
       try {
         ...
         // Seed Users
         const users = [
           { email: 'admin@example.com', password_hash: 'password1', name: 'Admin User', role: 'admin' },
           { email: 'agent@example.com', password_hash: 'password2', name: 'Agent User', role: 'agent' },
           { email: 'user@example.com', password_hash: 'password3', name: 'Regular User', role: 'user' }
         ];
